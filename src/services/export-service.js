...
import { extractFunctionDataForExport } from './decompiler-utils.js';

/**
 * Generate IDA Python script
 */
export function generateIDAScript(peData, analysisData) {
  const functionData = extractFunctionDataForExport(analysisData?.patterns?.functions || []);
...
def apply_analysis():
    ...
    # Set function names
    functions = ${JSON.stringify(functionData, null, 4)}
